...
public class EmsController {
	...
	public ResponseEntity<Employee> addEmployee(@RequestBody Employee emp) {
		Employee tb = ies.addEmployee(emp);
	...
	{
		List<Employee> employees=ies.getAllEmployees();
	...
	{
		Employee emp=ies.getEmployeeById(eUserId);
	...
	public ResponseEntity<List<Employee>> getAllEmployeesByPagination(@PathVariable String maxPage, String ofset){
		List<Employee> employees=ies.getAllEmployeesByPagination(ofset, ofset);
		return new ResponseEntity<List<Employee>>(employees,HttpStatus.OK);
	}
	...
	{
		int count = ies.getEmployeeCount();
